...
our %legalCodes = (
 ...
 "CNA" => "607 607", #Pavement Crown – aggregate – use where no stripeing
 "CNB" => "607 607", #Pavement Crown – HMA - use where no stripeing
 "CNC" => "607 607", #Pavement Crown – Concrete - use where no stripeing
 "CNP" => "683 683", #Canopy
 "CNT" => "225 225", #Signal Cantilever/Mast Arm
 "COL" => "609 609", #Column
 "CPH" => "103 103", #Control Point
 "CPT" => "354 ???", #Cathodic Protection Test Station – Gas
 ...
 "DCA" => "652 652", #Driveway – Commercial – Aggregate
 "DCB" => "652 652", #Driveway – Commercial – HMA
 "DCC" => "652 652", #Driveway – Commercial – Concrete
 "DCK" => "608 608", #Deck
 "DCR" => "652 652", #Driveway – Commercial – Brick
 "DFA" => "654 654", #Driveway – Field – Aggregate
 "DFB" => "654 654", #Driveway – Field – HMA
 "DFC" => "654 654", #Driveway – Field – Conc
 "DFG" => "654 654", #Driveway – Field – Ground
 "DFO" => "654 654", #Driveway – Field – Oil & Chip
 "DFR" => "654 654", #Driveway – Field – Brick
 "DPA" => "656 656", #Driveway – Public – Aggregate
 "DPB" => "656 656", #Driveway – Public – HMA
 "DPC" => "656 656", #Driveway – Public – Concrete
 "DPR" => "656 656", #Driveway – Public – Brick
 "DRA" => "649 649", #Driveway – Residential – Aggregate
 "DRB" => "649 649", #Driveway – Residential – HMA
 "DRC" => "649 649", #Driveway – Residential – Concrete
 "DRR" => "649 649", #Driveway – Residential – Brick
 "DSP" => "304 304", #Downspout
 "DTH" => "363 363", #Ditch - Flowline
 "DTP" => "359 359", #Paved Ditch Centerline
 "EOA" => "668 668", #EOP Line – Aggregate
 "EOB" => "668 668", #EOP Line – HMA
 "EOC" => "668 668", #EOP Line – Concrete
 "EOG" => "668 668", #EOP Line – Ground – Travelled Way
 "EOO" => "668 668", #EOP Line – Oil & Chip
 "EOR" => "668 668", #EOP Line – Brick
 ...
 "SPC" => "207 679", #Survey Point - Cut Cross
 ...
 "STR" => "609 703", #Stairs / Porch
 "SWA" => "291 705", #Sidewalk - Agg
 "SWB" => "291 706", #Sidewalk - HMA/BIT
 "SWC" => "291 707", #Sidewalk - Conc
 "SWN" => "291 ???", #Sidewalk - Stone/Rock
 "SWR" => "291 708", #Sidewalk - Brick
 "THW" => "858 719", #Thalweg - Lowest Point
 "TIL" => "304 709", #Field Tile/ Downspout
 "TNG" => "693 710", #Tank – Gas
 "TNP" => "693 711", #Tank – Petroleum
 "TNW" => "693 ???", #Tank – Water
 "TOE" => "860 712", #Toe of Slope
 "TOP" => "861 713", #Top of Slope
 "TRC" => "406 714", #Tree - Coniferous
 "TRD" => "405 715", #Tree - Deciduous
 "TRE" => "280 716", #Electric Transformer
 "TRF" => "220 717", #Traffic Signal
 "TRL" => "224 718", #Traffic Loop Detector
