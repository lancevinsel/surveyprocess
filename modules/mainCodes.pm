...
"ANC" => "ANC ACU", #Anchor - AMEREN
"APP" => "APP ACU", #Appurtenance - AMEREN
	...
	#			# the bridge beams. Usually only required on the outside (upstream and
	#			# downstream) beams.
"BND" => "BND 640", #Bend - AMEREN
	# "BOL" => "419 419", #Post / Bollard
"BOR" => "BOR 640", #Boring end - AMEREN
	...
	# "FDA" => "103 FDA", #Found Survey Evidence - Traverse Point
	# "FDB" => "207 FDB", #Found Survey Evidence - Axle
	# "FDC" => "207 FDC", #Found Survey Evidence - Cut Cross
	# "FDD" => "207 FDD", #Found Survey Evidence - Concrete Monument
	# "FDE" => "207 FDE", #Found Survey Evidence - Crimp Pipe
	# "FDF" => "103 FDF", #Found Survey Evidence - Benchmark
	# "FDG" => "103 FDG", #Found Survey Evidence - GPS Monument
	# "FDH" => "103 FDH", #Found Survey Evidence - Control Point
	# "FDI" => "207 FDI", #Found Survey Evidence - Iron Pipe
	# "FDJ" => "207 FDJ", #Found Survey Evidence - Nail
	# "FDK" => "207 FDK", #Found Survey Evidence - Nail & Washer/Shiner
	# "FDL" => "207 FDL", #Found Survey Evidence - PK Nail
	# "FDM" => "207 FDM", #Found Survey Evidence - Mag Nail
	# "FDN" => "213 FDN", #Found Survey Evidence - ROW Marker
	# "FDO" => "207 FDO", #Found Survey Evidence - RR Spike
	# "FDP" => "207 FDP", #Found Survey Evidence - Pole Barn Spike
	# "FDQ" => "207 FDQ", #Found Survey Evidence - Stone
	# "FDR" => "207 FDR", #Found Survey Evidence - Cotton Picker Spindle
	# "FDS" => "103 FDS", #Found Survey Evidence - Hub
	# "FDT" => "207 FDT", #Found Survey Evidence - Cut Square
	# "FDU" => "207 FDU", #Found Survey Evidence - Rebar
	# "FDV" => "207 FDV", #Found Survey Evidence - Drill Hole
	# "FDW" => "207 FDW", #Found Survey Evidence - Brass Marker
...
"FLG" => "FLG 418", #Flange - AMEREN
	# "FNG" => "418 418", #Fence - Gate post
	# "FNI" => "414 FNI", #Fence – Iron
"FNL" => "FNL FNL", #Fence – Chain Link -AMEREN
...
"FRN" => "FRN 795", #Foreign Pipeline - AMEREN
...
"GND" => "GND 604", #Ground Shot Adjacent - AMEREN
"GNF" => "GNF 604", #Ground Shot Final - AMEREN
...
"SNG" => "SNG 350", #Sign - Warning - Gas - AMEREN
...
"TEE" => "TEE THW", #Tee - AMEREN
	# "THW" => "858 THW", #Thalweg - Lowest Point
"TBK" => "TBK THW", #Trench Breaker - AMEREN
...
"VLG" => "VLG 723", #Valve – Gas - AMEREN
	...
	# "WET" => "379 379", #Wetland
"WLC" => "WLC 379", #Weld Cap - AMEREN
"WLD" => "WLD 379", #Weld - AMEREN
