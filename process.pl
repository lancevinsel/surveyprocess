...
%pointCodes = (  # ABC -> 123
 ...
 "BBS" => "620", # Bridge Seat.  The bridge seat elevation.  For elevation only.  Usually collected
                  # with the "hook".
 "BBW" => "708", #H Buffalo Box - Water
 #"BBX" => "320", # Water Buffalo Box
 "BCB" => "611", # Bridge Curb.  The top back of any curb or median on a bridge.
 "BDB" => "206", # Bridge Deck. The line of the bit bridge deck.  A 3d line.
 "BDC" => "206", # Bridge Deck. The line of the concrete bridge deck.  A 3d line.
 "BDP" => "206", # Bridge Deck Plate
 "BDT" => "206", # Bridge Desk Timber
 #"BDK" => "619", # Bridge Deck
 ...
 "BPA" => "207", # Bridge Parapet / Handrail.  A 2d line.
 ...
 "BPT" => "202", # The pier cap elevation,  For elevation only.  Usually collected
                  # with the "hook".
 ...
 "BUP" => "300", # Building - Public
 "BUR" => "300", # Building - Residential
 ...
 "BWW" => "203", # The outline of the face and sides of the wingwall.  A 3d line with
 ...
 "CNA" => "272", # Crown - AGG
 "CNB" => "272", # Crown - BIT/HMA - use stripeing as breakline where possible
 "CNC" => "272", # Crown - CONC - use stripeing as breakline where possible
 "CNR" => "272", # Crown - BRICK
 "CNP" => "350", # Canopy
 "CNT" => "225", # Traffic Signal Cantilever/Mast Arm
 "COL" => "352", #H Column
 "CPH" => "100", #H Control Point - modified v6
 "CRB" => "26C", #H Curb Top - Generic
 ...
 "EOA" => "24A", #H Edge of pavement - aggregate
 "EOB" => "24B", #H Edge of pavement - bit/hma
 "EOC" => "24C", #H Edge of pavement - concrete
 "EOL" => "678", # Edge of Lanes - added v6
 "EOR" => "24R", #H Edge of pavement - Brick
 ...
 "JUF" => "619", #H JULIE Communications Fiber Optic Mark
 "JUG" => "505", # JULIE Gas Mark
 "JUM" => "955", # JULIE Storm Mark
 "JUN" => "905", # JULIE Sanitary Mark
 "JUR" => "224",
 "JUS" => "224", # JULIE  Traffic Signal Fiber Optic Mark
 "JUT" => "606", # JULIE Telephone Mark
 "JUV" => "288",
 "JUW" => "705", # JULIE Watermain Mark
 ...
 "MTE" => "407", # Meter - Electric
 "MTG" => "507", #H Meter - Gas
 "MTW" => "707", # Meter Water
 "NPS" => "274", #H No passing line
 "PAB" => "31B", # Patio - Bit
 "PAC" => "31C", # Patio - Concrete
 "PAN" => "31N", # Patio - Stone
 "PAR" => "31R", # Patio - Brick
 ...
 "RRC" => "287", # RR Signal Cabinet
 "RRG" => "284", # RR Crossing Gate
 "RRH" => "288", # RR Switch Heater
 "RRM" => "286", # RR Mile Post
 "RRR" => "203", # RR Top of Rail
 "RRS" => "456",
 "RST" => "289", # RR Tie/Sleeper
 "RSW" => "455", # RR Switch Box
 "RSE" => "413", # Riser/Feed - Electric
 "RSG" => "513", # Riser/Feed - Gas
 "RST" => "613", # Riser/Feed - Telephone
 "RVT" => "606",
 "RWC" => "34C", #H Retaining Wall - Concrete
 "RWI" => "34I", #H Retaining Wall - Iron/Steel
 "RWL" => "343", #H Retaining Wall
 "RWN" => "34N", #H Retaining Wall - Stone
 "RWM" => "34M", #H Retaining Wall - Masonry
 "RWR" => "34R", #H Retaining Wall - Brick
 "RWT" => "34T", #H Retaining Wall - Timber
 ...
 "SLB" => "32B", # Slab - Bit
 "SLC" => "32C", # Slab - Concrete
 "SNC" => "373", # Sign - Commercial
 "SNE" => "418", # Sign - Electric Warning
 "SNF" => "350",
 "SNG" => "418", # Sign - Gas Warning
 "SNN" => "350", # Warning Sign - Sanitary
 "SNL" => "387", #H Sign Line - for large signs
 "SNP" => "350",
 "SNR" => "390", # Sign - Traffic
 "SNT" => "618", # Sign - Telephone Warning
 "SNV" => "350",
 "SNW" => "718", # Warning Sign - Water
 "SPA" => "100", # Traverse Point
 "SPB" => "101", # Axle
 "SPC" => "106", # Cut Cross
 "SPD" => "104", # Concrete Monument
 "SPE" => "105", # Crimp Pipe
 "SPF" => "102", # Bench Mark
 "SPG" => "107", # GPS Monument
 "SPI" => "109", # Iron Pipe
 "SPJ" => "110", # Nail
 "SPK" => "111", # Nail and Shiner/Washer
 "SPL" => "112", # PK Nail
 "SPM" => "112", # Mag Nail
 "SPO" => "114", # RR Spike
 "SPQ" => "115", # Stone
 "SPR" => "116", # Cotton Picker Spindle
 "SPS" => "117", # Hub
 "SPW" => "103", # Brass Marker
 "SPX" => "108", # Iron Rod/Pin
 "SPZ" => "118", # Other
 "STR" => "357", # Stairs/Porch
 "SWK" => "291",
 "SWA" => "33A", # SIDEWALK - AGG
 "SWB" => "33B", # SIDEWALK - BIT/HMA
 "SWC" => "33C", # SIDEWALK - CONC
 "SWR" => "33R", # SIDEWALK - BRICK
 "TIL" => "304", # Tile
 "TNG" => "514", # Gas Tank
 "TOE" => "152", # Toe of Slope
 "TOP" => "153", # Top of Slope
