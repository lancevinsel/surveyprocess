...
%pointCodes = (  # ABC -> 123
 ...
 "C03" => "D03", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C06" => "D06", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C09" => "D09", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C12" => "D12", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C15" => "D15", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C18" => "D18", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C24" => "D24", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C30" => "D30", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C36" => "D36", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C42" => "D42", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C48" => "D48", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "C54" => "D54", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 ...
 "CUP" => "962", #H Culvert
 "CBM" => "943", #H Catch Basin Grate
 "D03" => "D03", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D06" => "D06", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D09" => "D09", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D12" => "D12", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D15" => "D15", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D18" => "D18", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D24" => "D24", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D30" => "D30", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D36" => "D36", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D42" => "D42", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D48" => "D48", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D54" => "D54", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D60" => "D60", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D66" => "D66", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "D72" => "D72", #H Hoellsher Tree Codes - these need to be changes in the .TXT file and then just pass through
 "DAM" => "369",
 ...
 "EOA" => "247", #H Edge of pavement - aggregate
 ...
 "RVT" => "606",
 "RWC" => "343", #H Retaining Wall - Concrete
 "RWI" => "340", #H Retaining Wall - Iron/Steel
 "RWL" => "343", #H Retaining Wall
 "RWN" => "347", #H Retaining Wall - Stone
 "RWM" => "342", #H Retaining Wall - Masonry
 "RWR" => "342", #H Retaining Wall - Brick
 ...
 "SWK" => "291",
 "SWA" => "337", # SIDEWALK - AGG
 "SWB" => "331", # SIDEWALK - BIT/HMA
 "SWC" => "333", # SIDEWALK - CONC
 "SWR" => "332", # SIDEWALK - BRICK
 "TIL" => "304", # Tile
 "TNG" => "514", # Gas Tank
...
#     print OUT6 "$in[0],$in[1],$in[2],$in[3],$c $Icode\n";
     print OUT6 "$in[0],$in[1],$in[2],$in[3],$c $Icode$csplit[1]\n";
  }
  else  {
#     print OUT6 "$in[0],$in[1],$in[2],$in[3],$Icode$fsplit[1],\n";
#     print OUT6 "$in[0],$in[1],$in[2],$in[3],$Icode\n";
     print OUT6 "$in[0],$in[1],$in[2],$in[3],$Icode$csplit[1]\n";
  }
 }
