...
%legalCodes = (
 ...
 # Hoellsher Tree Codes
 # These need to be changed manually in the .TXT file !!!!!!!
 "C03" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C06" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C09" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C12" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C15" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C18" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C24" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C30" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C36" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C42" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C48" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C54" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C60" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C66" => "legal", # Deciduous Tree - last 2 character are size in inches
 "C72" => "legal", # Deciduous Tree - last 2 character are size in inches
 ...
 # Hoellsher Tree Codes
 # These need to be changed manually in the .TXT file !!!!!!!
 "D03" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D06" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D09" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D12" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D15" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D18" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D24" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D30" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D36" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D42" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D48" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D54" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D60" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D66" => "legal", # Deciduous Tree - last 2 character are size in inches
 "D72" => "legal", # Deciduous Tree - last 2 character are size in inches
 ...
 "FNI" => "legal", # Fence - Iron
 "FNL" => "legal", # Fence - Chain Link
 "FNT" => "legal", # Fence - Wood
 ...
 "SPG" => "legal", # GPS Monument
 "SPI" => "legal", # Iron Pipe
 "SPJ" => "legal", # Nail
 "SPK" => "legal", # Nail and Shiner/Washer
 "SPL" => "legal", # PK Nail
 "SPM" => "legal", # Mag Nail
 "SPO" => "legal", # RR Spike
 "SPQ" => "legal", # Stone
 "SPR" => "legal", # Cotton Picker Spindle
 "SPS" => "legal", # Hub
 "SPW" => "legal", # Brass Marker
 "SPX" => "legal", # Iron Rod/Pin
 "SPZ" => "legal", # Other
